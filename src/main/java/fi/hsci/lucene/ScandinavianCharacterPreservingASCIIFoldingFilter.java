 ...
 */
public final class ScandinavianCharacterPreservingASCIIFoldingFilter extends TokenFilter {
    ...
    public ScandinavianCharacterPreservingASCIIFoldingFilter(TokenStream input)
    {
        this(input, false);
    }

    /**
     * Create a new {@link fi.hsci.lucene.analysis.ScandinavianCharacterPreservingASCIIFoldingFilter}.
     *
     * @param input
     ...
     **/
    public ScandinavianCharacterPreservingASCIIFoldingFilter(TokenStream input, boolean preserveOriginal)
    {
        super(input);
